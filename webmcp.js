/*
  Experimental WebMCP integration for Auckland Car Glass.
...
(function () {
  ...
  var tool = {
    ...
    description: "Request a windscreen or auto-glass quote from Auckland Car Glass. Collects the customer's contact and vehicle details and submits an enquiry. Use when a user wants a quote, booking, or to replace a windscreen / side window / back glass.",
    inputSchema: {
      type: "object",
      properties: {
    ...
    execute: async function (args) {
      ...
      try {
        ...
        return { content: [{ type: "text", text: ok
          ? "Quote request sent to Auckland Car Glass. We'll be in touch shortly on the number provided. For urgent help call 0800 202 888."
          : "Could not submit the quote automatically. Please call Auckland Car Glass on 0800 202 888 or use the contact form." }] };
      } catch (e) {
        return { content: [{ type: "text", text: "Could not submit the quote automatically. Please call Auckland Car Glass on 0800 202 888." }] };
      }
    }
  };
